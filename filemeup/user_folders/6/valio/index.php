        ...
        <div class="container">
            <div class="row1">
                <div style="margin: auto 0;">
                    <form method="post" id="search_form" method="post">
                        <label>Search</label>
...
<div id="uploadModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="upload_form" ecntype='multipart/form-data'>
                    <p> Select Image
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','.remove_file', function(){
            ...
            if(confirm("Are you sure you want to remove this file?"))
            {
                $.ajax({
                    url:"action.php",
                    method:"POST",
                    data:{path:path, action: action, fileName:fileName},
                    success:function(data)
                    {
                        alert(data);
        ...
        $(document).on('blur', '.change_file_name', function(){
            ...
            $.ajax({
                url:"action.php",
                method:"POST",
                data:{folder_name:$the_folder_name, old_file_name:old_file_name, new_file_name:new_file_name, action:action},
                success:function(data)
                {
                    alert(data);
                }
